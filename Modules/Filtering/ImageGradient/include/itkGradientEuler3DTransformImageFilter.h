 ...
 *
 *=========================================================================*/
#ifndef itkGradientEuler3DTransformImageFilter_h
#define itkGradientEuler3DTransformImageFilter_h
...
/** \class GradientEuler3DTransformImageFilter
...
template< typename TInputImage,
          ...
          typename TOutputImageType = Image< CovariantVector< TOutputValueType,
                                                           TInputImage::ImageDimension*Euler3DTransform<TOutputValueType>::ParametersDimension >,
...
public:
  ...
  itkStaticConstMacro(ParametersDimension, unsigned int,
                      Euler3DTransform<TOutputValueType>::ParametersDimension);
  itkStaticConstMacro(OutputImageDimension, unsigned int,
                      InputImageDimension * ParametersDimension);

  /** Standard class typedefs. */
  typedef GradientEuler3DTransformImageFilter Self;
  ...
  itkTypeMacro(GradientEuler3DTransformImageFilter, ImageToImageFilter);
  ...
  /** GradientEuler3DTransformImageFilter needs a larger input requested region than
   * the output requested region.  As such, GradientEuler3DTransformImageFilter needs
...
protected:
  ...
  virtual ~GradientEuler3DTransformImageFilter();
  void PrintSelf(std::ostream & os, Indent indent) const ITK_OVERRIDE;

  /** GradientEuler3DTransformImageFilter can be implemented as a multithreaded filter.
...
private:
  GradientEuler3DTransformImageFilter(const Self &) ITK_DELETE_FUNCTION;
...
#include "itkGradientEuler3DTransformImageFilter.hxx"
#endif
